...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/cpsc426Util
  TARGETDIR  = lib
  TARGET     = $(TARGETDIR)/libcpsc426Util.dylib
  DEFINES   += -DDEBUG -D_CRT_SECURE_NO_WARNINGS -D_SCL_SECURE_NO_WARNINGS
  INCLUDES  += -I. -Iutil -Iinclude/eigen
  ...
  ALL_LDFLAGS   += $(LDFLAGS) -Llib -L. -dynamiclib -m32 -L/usr/lib32 -stdlib=libc++ -Wl,-rpath,/Users/matthewhounslow/Desktop/cs426_a2/lib -framework OpenGL -framework Cocoa -framework IOKit -framework CoreVideo -install_name @rpath/libcpsc426Util.dylib
  LDDEPS    +=
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/cpsc426Util
  TARGETDIR  = lib
  TARGET     = $(TARGETDIR)/libcpsc426Util.dylib
...
ifeq ($(config),debug64)
  OBJDIR     = obj/x64/Debug/cpsc426Util
  TARGETDIR  = lib
  TARGET     = $(TARGETDIR)/libcpsc426Util.dylib
  DEFINES   += -DDEBUG -D_CRT_SECURE_NO_WARNINGS -D_SCL_SECURE_NO_WARNINGS
  INCLUDES  += -I. -Iutil -Iinclude/eigen
  ...
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS)
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -Llib -L. -dynamiclib -m64 -L/usr/lib64 -stdlib=libc++ -Wl,-rpath,/Users/matthewhounslow/Desktop/cs426_a2/lib -framework OpenGL -framework Cocoa -framework IOKit -framework CoreVideo -install_name @rpath/libcpsc426Util.dylib
  LDDEPS    +=
  LIBS      += $(LDDEPS) -framework OpenGL -ldl -lpthread
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/cpsc426Util
  TARGETDIR  = lib
  TARGET     = $(TARGETDIR)/libcpsc426Util.dylib
  DEFINES   += -DNDEBUG -D_CRT_SECURE_NO_WARNINGS -D_SCL_SECURE_NO_WARNINGS
  INCLUDES  += -I. -Iutil -Iinclude/eigen
