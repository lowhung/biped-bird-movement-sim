...
ifeq ($(config),debug32)
  OBJDIR     = obj/x32/Debug/jsoncpp
  TARGETDIR  = lib
  TARGET     = $(TARGETDIR)/libjsoncpp.dylib
  DEFINES   += -DDEBUG -D_CRT_SECURE_NO_WARNINGS -D_SCL_SECURE_NO_WARNINGS
  INCLUDES  += -Ijsoncpp/include
  ...
  ALL_LDFLAGS   += $(LDFLAGS) -Llib -L. -dynamiclib -m32 -L/usr/lib32 -stdlib=libc++ -Wl,-rpath,/Users/matthewhounslow/Desktop/cs426_a2/lib -install_name @rpath/libjsoncpp.dylib
  LDDEPS    +=
...
ifeq ($(config),release32)
  OBJDIR     = obj/x32/Release/jsoncpp
  TARGETDIR  = lib
  TARGET     = $(TARGETDIR)/libjsoncpp.dylib
...
ifeq ($(config),debug64)
  ...
  ALL_CXXFLAGS  += $(CXXFLAGS) $(ALL_CFLAGS)
  ALL_RESFLAGS  += $(RESFLAGS) $(DEFINES) $(INCLUDES)
  ALL_LDFLAGS   += $(LDFLAGS) -Llib -L. -dynamiclib -m64 -L/usr/lib64 -stdlib=libc++ -Wl,-rpath,/Users/matthewhounslow/Desktop/cs426_a2/lib -install_name @rpath/libjsoncpp.dylib
  LDDEPS    +=
  LIBS      += $(LDDEPS) -framework OpenGL -framework Cocoa -ldl -lpthread
  LINKCMD    = $(CXX) -o $(TARGET) $(OBJECTS) $(RESOURCES) $(ARCH) $(ALL_LDFLAGS) $(LIBS)
  define PREBUILDCMDS
...
ifeq ($(config),release64)
  OBJDIR     = obj/x64/Release/jsoncpp
  TARGETDIR  = lib
  TARGET     = $(TARGETDIR)/libjsoncpp.dylib
  DEFINES   += -DNDEBUG -D_CRT_SECURE_NO_WARNINGS -D_SCL_SECURE_NO_WARNINGS
  INCLUDES  += -Ijsoncpp/include
...
$(OBJDIR)/json_reader.o: jsoncpp/src/lib_json/json_reader.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"

$(OBJDIR)/json_value.o: jsoncpp/src/lib_json/json_value.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"

$(OBJDIR)/json_writer.o: jsoncpp/src/lib_json/json_writer.cpp
	@echo $(notdir $<)
	$(SILENT) $(CXX) $(ALL_CXXFLAGS) $(FORCE_INCLUDE) -o "$@" -MF $(@:%.o=%.d) -c "$<"
